    ...
    const CategoryCard = ({ icon, title, delay }) => (
      ...
      >
        <div className="bg-yellow-400 text-red-700 p-4 rounded-full mb-4">{icon}</div>
    ...
    const ProfessionalCard = ({ name, specialty, rating, image, delay }) => {
      ...
      return (
        ...
        >
            <img  alt={name} className="w-24 h-24 rounded-full object-cover mb-4 border-4 border-yellow-400" src="https://images.unsplash.com/photo-1595872018818-97555653a011" />
    ...
    const Home = () => {
      ...
      return (
        <>
          ...
          <div className="bg-red-600 text-white relative overflow-hidden" style={{backgroundImage: "url('https://www.transparenttextures.com/patterns/inspiration-geometry.png')"}}>
          ...
          <section className="bg-red-700 text-white" style={{backgroundImage: "url('https://www.transparenttextures.com/patterns/inspiration-geometry.png')"}}>
            <div className="container mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <h2 className="text-3xl font-bold mb-4 text-yellow-400">Sobre a plataforma</h2>
              ...
              >
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-yellow-400 text-red-700 hover:bg-yellow-500 font-bold">
