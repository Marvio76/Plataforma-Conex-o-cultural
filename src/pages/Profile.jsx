        ...
        return (
            <>
                ...
                <div className="bg-orange-50" style={backgroundStyle}>
                    ...
                    >
                        <div className="relative h-48 md:h-64 bg-red-200">
                        ...
                        <div className="container mx-auto px-6 -mt-16 md:-mt-24">
                            <div className="flex items-end space-x-4">
                                ...
                                {!isOwnProfile && (
                                    <Button onClick={showToast} className="mb-4 bg-red-600 hover:bg-red-700">Apoiar</Button>
                                )}
                            </div>
                        </div>
                    </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            >
                                <div className="bg-white p-6 rounded-lg shadow-md">
                                    <h2 className="text-2xl font-bold text-stone-800 mb-4">Descrição Profissional {isOwnProfile && <EditButton />}</h2>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-md">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        {isOwnProfile && (
                                            <Button onClick={showToast} size="sm" className="bg-red-500 hover:bg-red-600"><Plus className="mr-2 h-4 w-4" /> Adicionar</Button>
                                        )}
                                    </div>
                            ...
                            >
                                <div className="bg-white p-6 rounded-lg shadow-md">
                                    ...
                                    <div className="space-y-3">
                                        <p className="flex items-center text-stone-600"><Mail className="mr-3 text-red-600" size={20} /> erika.andrade@email.com</p>
                                        <p className="flex items-center text-stone-600"><Phone className="mr-3 text-red-600" size={20} /> (98) 98888-7777</p>
                                        <p className="flex items-center text-stone-600"><MapPin className="mr-3 text-red-600" size={20} /> Atendimento em domicílio - São Luís, MA</p>
                                    </div>
                                </div>
                                <div className="bg-white p-6 rounded-lg shadow-md">
                                    <h2 className="text-2xl font-bold text-stone-800 mb-4">Redes Sociais {isOwnProfile && <EditButton />}</h2>
                                    <div className="space-y-3">
                                       <a href="#" className="flex items-center text-red-600 hover:underline">Instagram: @erika_trancas</a>
                                       <a href="#" className="flex items-center text-red-600 hover:underline">Facebook: /erikatrancista</a>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
    ...
    const EditButton = () => {
        const { toast } = useToast();
        return (
            <Button variant="ghost" size="icon" className="h-6 w-6 ml-2" onClick={() => toast({ title: '🚧 Em breve!', description: 'A edição do perfil estará disponível em breve.'})}>
