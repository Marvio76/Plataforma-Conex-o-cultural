      ...
      return (
        ...
        >
          ...
          <div className="p-6 flex-grow flex flex-col">
            ...
            <p className="text-sm text-stone-600 mb-1 flex items-center"><Calendar size={14} className="mr-2 text-red-600" /> {period}</p>
            <p className="text-sm text-stone-600 mb-4 flex items-center"><MapPin size={14} className="mr-2 text-red-600" /> {local}</p>
